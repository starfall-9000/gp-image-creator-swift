...
public struct GPImageEditor {
    ...
    public static func present(from viewController: UIViewController, image: UIImage, animated: Bool, handlePrivacyAction: (() -> Void)? = nil, finished: @escaping ((UIImage) -> Void), completion: (() -> Void)? = nil, didDismissScreen: ((Bool) -> Void)? = nil) {
